...
## Before: gcm_1_results.RData (model)
## After:  gcm_1_agepred.csv, gcm_1_coefs.csv, gcm_1_conv.csv, gcm_1_curve.csv,
##         gcm_1_otofit.csv, gcm_1_residuals.csv, gcm_1_sigma.csv (output)
...
## Read model results
load("model/gcm_1_results.RData")
...
## Export tables
write.taf(agepred, "output/gcm_1_agepred.csv")
write.taf(coefs, "output/gcm_1_coefs.csv")
write.taf(conv, "output/gcm_1_conv.csv")
write.taf(curve, "output/gcm_1_curve.csv")
write.taf(otofit, "output/gcm_1_otofit.csv")
write.taf(res, "output/gcm_1_residuals.csv")
write.taf(sigma, "output/gcm_1_sigma.csv")
