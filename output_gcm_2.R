...
## Before: gcm_2_results.RData (model)
## After:  gcm_2_agepred.csv, gcm_2_coefs.csv, gcm_2_conv.csv, gcm_2_curve.csv,
##         gcm_2_residuals.csv, gcm_2_sigma.csv (output)
...
## Read model results
load("model/gcm_2_results.RData")
...
## Export tables
write.taf(agepred, "output/gcm_2_agepred.csv")
write.taf(coefs, "output/gcm_2_coefs.csv")
write.taf(conv, "output/gcm_2_conv.csv")
write.taf(curve, "output/gcm_2_curve.csv")
write.taf(otofit, "output/gcm_2_otofit.csv")
write.taf(res, "output/gcm_2_residuals.csv")
write.taf(sigma, "output/gcm_2_sigma.csv")
